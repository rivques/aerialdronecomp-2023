...
if __name__ == "__main__":
    ...
    SequentialAction(drone_manager, [
        ...
        GoToAction(fl.in_to_m(48), 0.1, fl.yellow_keyhole[2],"YKeyholeLoopUp", 3), #  get to right height for keyhole
        ...
        GoToAction(fl.green_keyhole[0]+0.1,fl.green_keyhole[1]+0.3,None,"GKeyholeLoopThrough",2), # go through keyhole and align for next keyhole
