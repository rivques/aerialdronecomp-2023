...
if __name__ == "__main__":
    ...
    SequentialAction(drone_manager, [
        ...
        GoToAction(fl.in_to_m(48), fl.yellow_keyhole[1], None, "GoThroughArch", 5), # go through arch and align for keyhole on xy plane
        GoToAction(None, None, fl.yellow_keyhole[2],"YKeyholePrepareHeight", 5), #  get to right height for keyhole
        WaitAction(1), # settle a bit
        GoToAction(fl.green_keyhole[0], None, None,"GoThroughYKeyhole", 3), # go through keyhole and align for next keyhole
        ...
        WaitAction(1), # settle a bit
        GoToAction(None, fl.green_keyhole[1]+0.30, None, "GoThroughGKeyhole",3),
        GoToAction(None, None, fl.blue_arch[2], "BArchPrepareHeight",3), # prepare to go through blue arch
        WaitAction(1), # settle a bit
        GoToAction(fl.mat_2[0], fl.mat_2[1], None, "GoThroughBlueArch",3), # go through blue arch 
        WaitAction(1), # settle a bit
        LandAction(),
        ReadColorAndSetLEDAction(),
